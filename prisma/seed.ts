...
async function main() {
  ...
  const proveedoresSeed = [
    { id: 'P-001', nombre: 'CloudSphere Technologies', iniciales: 'CS', categorias: ['TI', 'Cloud'], score: 94, ubicacion: 'Bogotá, CO', certificaciones: ['ISO 27001', 'ISO 9001', 'ESG'], procesosGanados: 18, entregasATiempo: 97, color: 'oklch(0.60 0.22 280)', userId: diego.id },
    ...
    { id: 'P-007', nombre: 'AuditTrust Asociados', iniciales: 'AT', categorias: ['Servicios Generales', 'Auditoría'], score: 96, ubicacion: 'Bogotá, CO', certificaciones: ['ISO 9001', 'ISO 27001'], procesosGanados: 14, entregasATiempo: 99, color: 'oklch(0.55 0.22 280)' },
    ...
    { id: 'P-010', nombre: 'NovaTech Consulting', iniciales: 'NT', categorias: ['TI', 'Consultoría'], score: 92, ubicacion: 'Montevideo, UY', certificaciones: ['ISO 27001', 'ESG', 'ISO 9001'], procesosGanados: 20, entregasATiempo: 96, color: 'oklch(0.50 0.24 280)' },
